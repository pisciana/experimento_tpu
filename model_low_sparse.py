...
#        b2 = bias_variable([out_dim])
        ...
        #self.mask = np.zeros(W1.get_shape().as_list())
        #num_zeros = np.round(np.prod(W1.get_shape())*sparseness)
        ...
        #
        #
        # criar mascara baseada em in_dim, outdim e sparsnes
        # W1 = W1 * mascara
        #
        #
...
#        self.var_list = [W1, b1, W2, b2]
        ...
        #self.new_cross_entropy = self.cross_entropy + np.sum (pesos de W1 nas posicoes mascaras) 
        #
        #
...
#        
#mean_correct = self.y[tf.argmax(y_,1)]
#        mean_noise = 
